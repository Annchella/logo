export default function handler(req, res) {
    const data = [
        ...
        },
        {
            ...
            "description": "placerat eget ex tincidunt placeholder quam viverra viverra In Donec non non orci libero, nulla, nisi sed maximus vitae lorem. Praesent elit viverra dui. viverra lacus, luctus quis Vestibulum placeholder. maximus nibh efficitur. id scelerisque",
